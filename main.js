document.addEventListener('DOMContentLoaded', () => {
    ...
    if (doArrayStart === null) { /* если исходный массив пуст (что невозможно, но код работает только так, или я просто туп) */
        ...
        render(localDoArrayStart, doList, 'start', 'submit__do', 'img/right.png'); /* ну а если всё в порядке, рендерим список, как задумано, из localStorage */
    }
    ...
    if (doArrayProcess === null) {
        ...
        render(localDoArrayProcess, doListProcess, 'process', 'done__do', 'img/load.gif');
    }
    ...
    if (doArrayDone === null) {
        ...
        render(localDoArrayDone, doListDone, 'done', 'success__do', 'img/done.svg');
    }
    ...
    formAddDo.addEventListener('submit', (e) => {
        ...
        if (textDo.value === '') {
            ...
            render(localDoArrayStart, doList, 'start', 'submit__do', 'img/right.png');
        ...
        scroll(localDoArrayStart, doList, 7);
        ...
        if (localDoArrayStart.length >= 10) {
            ...
            achivmentImg.setAttribute('src', 'img/gif-start.gif');
    ...
    doList.addEventListener('mouseup', () => {
        ...
        doList.querySelectorAll('.submit__do').forEach(function(btn, j) {
            btn.addEventListener('click', function() {
                ...
                scroll(localDoArrayProcess, doListProcess, 7);
                ...
                if (localDoArrayProcess.length >= 10) {
                    ...
                    achivmentImg.setAttribute('src', 'img/gif-process.gif');
                    achivmentImg.setAttribute('width', 100);
                    achivmentImg.setAttribute('height', 100);
    ...
    doListProcess.addEventListener('mouseup', (e) => {
       ...
       doListProcess.querySelectorAll('.done__do').forEach(function(btn, j) {
            btn.addEventListener('click', function() {
                ...
                render(localDoArrayDone, doListDone, 'done', 'success__do', 'done.svg');
                // createDoneDoosList(doArrayDone, doListDone);

                scroll(localDoArrayDone, doListDone, 7);
                ...
                if (localDoArrayDone.length >= 10) {
                    ...
                    achivmentImg.setAttribute('src', 'img/gif-done.gif');
                    achivmentImg.setAttribute('width', 100);
                    achivmentImg.setAttribute('height', 100);
    ...
    switchTeme.addEventListener('click', () => {
        ...
        if (switchTeme.classList.contains('switchOn')) {
            setTimeout(() => {
                setTimeout(() => {
                    iconTheme.setAttribute('src', 'img/night.png'); /* меняем изображение при смене темы оформления */
                }, 0);
            ...
            setTimeout(() => {
                setTimeout(() => {
                    iconTheme.setAttribute('src', 'img/day.png'); /* меняем изображение при смене темы оформления */
                }, 0);
